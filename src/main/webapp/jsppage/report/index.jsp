        ...
        <table class="table table-striped table-hover table-bordered">
          <tbody>
            <tr>
              ...
              <td class="td_cont"><fmt:formatDate value="${obj.logStartTime}" pattern="yyyy-MM-dd HH:mm:ss"></fmt:formatDate></td>
              <td class="td_bg">记录结束时间</td>
              <td class="td_cont"><fmt:formatDate value="${obj.logEndTime}" pattern="yyyy-MM-dd HH:mm:ss"></fmt:formatDate></td>
        ...
        <table class="table table-striped table-hover table-bordered">
          <tbody>
            <tr>
              ...
              <td class="td_cont">${obj.maxSystolic}(<fmt:formatDate value="${obj.maxSystolicTime}" pattern="HH:mm:ss"></fmt:formatDate>)</td>
              <td class="td_bg">收缩压(最低)</td>
              <td class="td_cont">${obj.minSystolic}(<fmt:formatDate value="${obj.minSystolicTime}" pattern="HH:mm:ss"></fmt:formatDate>)</td>
              <td class="td_bg">收缩压(平均)</td>
              <td class="td_cont"><fmt:formatNumber pattern="0.00" value="${obj.avgSystolic}"></fmt:formatNumber></td>
              <td class="td_bg">舒张压(最高)</td>
              <td class="td_cont">${obj.maxDiastolic}(<fmt:formatDate value="${obj.maxDiastolicTime}" pattern="HH:mm:ss"></fmt:formatDate>)</td>
              </tr>
              <tr>
              <td class="td_bg">舒张压(最低)</td>
              <td class="td_cont">${obj.minDiastolic}(<fmt:formatDate value="${obj.minDiastolicTime}" pattern="HH:mm:ss"></fmt:formatDate>)</td>
              <td class="td_bg">舒张压(平均)</td>
              <td class="td_cont">${obj.avgDiastolic}<fmt:formatNumber pattern="0.00" value="${obj.avgDiastolic}"></fmt:formatNumber></td>
    ...
    <th>最小值</th>
          ...
          <tbody>
            <tr>
              ...
              <td>${obj.maxSystolic}(<fmt:formatDate value="${obj.maxSystolicTime}" pattern="HH:mm:ss"></fmt:formatDate>)</td>
              <td>${obj.minSystolic}(<fmt:formatDate value="${obj.minSystolicTime}" pattern="HH:mm:ss"></fmt:formatDate>)</td>
            </tr>
            <tr>
              <td>舒张压(mmHg)</td>
              <td><fmt:formatNumber pattern="0.00" value="${obj.avgDiastolic}"></fmt:formatNumber></td>
              <td>${obj.maxDiastolic}(<fmt:formatDate value="${obj.maxDiastolicTime}" pattern="HH:mm:ss"></fmt:formatDate>)</td>
              <td>${obj.minDiastolic}(<fmt:formatDate value="${obj.minDiastolicTime}" pattern="HH:mm:ss"></fmt:formatDate>)</td>
            </tr>
            <tr>
              <td>心率(BPM)</td>
    ...
    <th>最小值</th>
          ...
          <tbody>
            <tr>
              ...
              <td>${obj.daymaxSystolic}(<fmt:formatDate value="${obj.daymaxSystolicTime}" pattern="HH:mm:ss"></fmt:formatDate>)</td>
              <td>${obj.dayminSystolic}(<fmt:formatDate value="${obj.dayminSystolicTime}" pattern="HH:mm:ss"></fmt:formatDate>)</td>
            </tr>
            <tr>
              <td>舒张压(mmHg)</td>
              <td><fmt:formatNumber pattern="0.00" value="${obj.dayavgDiastolic}"></fmt:formatNumber></td>
              <td>${obj.daymaxDiastolic}(<fmt:formatDate value="${obj.daymaxDiastolicTime}" pattern="HH:mm:ss"></fmt:formatDate>)</td>
              <td>${obj.dayminDiastolic}(<fmt:formatDate value="${obj.dayminDiastolicTime}" pattern="HH:mm:ss"></fmt:formatDate>)</td>
            </tr>
            <tr>
              <td>心率(BPM)</td>
