...
(function (L, S) {
    ...
    L = function () {
        var a = window, D = a.document, A = a.navigator && a.navigator.userAgent || "",
            G = D && D.createElementNS && !!D.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect,
            F = /(edge|msie|trident)/i.test(A) && !window.opera, n = !G, f = /Firefox/.test(A),
    ...
    (function (a) {
        var D = [], A = a.charts, G = a.doc, F = a.win;
        ...
        a.Fx.prototype = {
            dSetter: function () {
                ...
                if (1 === l) h = this.toD; else if (w === f.length && 1 > l)for (; w--;)t = parseFloat(a[w]), h[w] = isNaN(t) ? a[w] : l * parseFloat(f[w] - t) + t; else h = f;
                this.elem.attr("d", h, null, !0)
            }, update: function () {
                var a = this.elem, f = this.prop, h = this.now, l = this.options.step;
                ...
                var f = +new Date, h, l = this.options, w = this.elem,
                    t = l.complete, e = l.duration, d = l.curAnim;
                ...
                C && (l(f),
                    l(h));
                if (d && m) {
                    for (u = 0; u < d.length; u++)if (d[u] === m[0]) {
                        e = u;
                        break
        ...
        a.pick = function () {
            ...
            for (f = 0; f < l; f++)if (h = a[f], void 0 !== h && null !== h)return h
        };
        a.css = function (n, f) {
        ...
        a.wrap = function (a, f, h) {
            var l = a[f];
            a[f] = function () {
                var a = Array.prototype.slice.call(arguments), f = arguments, e = this;
                e.proceed = function () {
        ...
        a.dateFormat = function (n, f, h) {
            ...
            var l = a.Date, w = new l(f - a.getTZOffset(f)), t = w[l.hcGetHours](), e = w[l.hcGetDay](),
                d = w[l.hcGetDate](), m = w[l.hcGetMonth](), C = w[l.hcGetFullYear](), b = a.defaultOptions.lang,
                x = b.weekdays, c = b.shortWeekdays, u = a.pad, l = a.extend({
        ...
        a.formatSingle = function (n, f) {
            var h = /\.([0-9])/, l = a.defaultOptions.lang;
            /f$/.test(n) ? (h = (h =
        ...
        a.offset = function (a) {
            ...
            return {
                ...
                f.scrollTop) - (f.clientTop || 0), left: a.left + (F.pageXOffset || f.scrollLeft) - (f.clientLeft || 0)
            }
        };
        a.stop = function (a, f) {
        ...
        a.removeEvent = function (n, f, h) {
            ...
            function w() {
                ...
                n.nodeName && (f ? (d = {}, d[f] = !0) : d = e, a.objectEach(d, function (a, d) {
                    if (e[d])for (C = e[d].length; C--;)l(d, e[d][C])
                }))
            }
        ...
        a.fireEvent = function (n, f, h, l) {
            ...
            var t, e;
            h = h || {};
            if (G.createEvent && (n.dispatchEvent || n.fireEvent)) w = G.createEvent("Events"), w.initEvent(f, !0, !0), a.extend(w, h), n.dispatchEvent ? n.dispatchEvent(w) : n.fireEvent(f, w); else if (w)for (w = w[f] || [], t = w.length, h.target || a.extend(h, {
        ...
        a.seriesType = function (n, f, h, l, w) {
            var t = a.getOptions(), e = a.seriesTypes;
        ...
        Array.prototype.forEach || (a.each = function (a, f, h) {
            for (var l = 0, n = a.length; l < n; l++)if (!1 === f.call(h, a[l], l, a))return l
        });
        Array.prototype.indexOf || (a.inArray = function (a, f) {
            var h, l = 0;
            if (f)for (h = f.length; l < h; l++)if (f[l] === a)return l;
            return -1
        });
        ...
        Array.prototype.find || (a.find = function (a, f) {
            var h, l = a.length;
            for (h = 0; h < l; h++)if (f(a[h], h))return a[h]
        })
    })(L);
    (function (a) {
        var D =
            a.each, A = a.isNumber, G = a.map, F = a.merge, n = a.pInt;
        a.Color = function (f) {
        ...
        a.Color.prototype = {
            ...
            init: function (f) {
                ...
                }); else if (f && "#" === f[0] && (h = f.length, f = parseInt(f.substr(1), 16), 7 === h ? l = [(f & 16711680) >> 16, (f & 65280) >> 8, f & 255, 1] : 4 === h && (l = [(f & 3840) >> 4 | (f & 3840) >> 8, (f & 240) >> 4 | f & 240, (f & 15) << 4 | f & 15, 1])), !l)for (n = this.parsers.length; n-- && !l;)t = this.parsers[n], (h = t.regex.exec(f)) && (l = t.parse(h));
                this.rgba = l || []
            }, get: function (a) {
                ...
                if (this.stops) D(this.stops, function (f) {
                    f.brighten(a)
                }); else if (A(a) && 0 !== a)for (f = 0; 3 > f; f++)l[f] += n(255 * a), 0 > l[f] && (l[f] = 0), 255 < l[f] && (l[f] = 255);
                return this
    ...
    (function (a) {
        var D, A, G = a.addEvent, F = a.animate, n = a.attr, f = a.charts, h = a.color, l = a.css, w = a.createElement,
            t = a.defined, e = a.deg2rad, d = a.destroyObjectProperties, m = a.doc, C = a.each, b = a.extend,
            x = a.erase, c = a.grep, u = a.hasTouch, B = a.inArray, I = a.isArray, k = a.isFirefox, E = a.isMS,
            p = a.isObject, z = a.isString, M = a.isWebKit, q = a.merge, y = a.noop, H = a.objectEach, K = a.pick,
            g = a.pInt, r = a.removeEvent, R = a.stop, J = a.svg, N = a.SVG_NS, O = a.symbolSizes, P = a.win;
        ...
        D.prototype = {
            ...
            colorGradient: function (v, g, b) {
                ...
                k && (p = v[k], Q = r.gradients, u = v.stops, y = b.radialReference, I(p) && (v[k] =
                    ...
                    }), "radialGradient" === k && y && !t(p.gradientUnits) && (d = p, p = q(p, r.getRadialAttr(y, d), {gradientUnits: "userSpaceOnUse"})), H(p, function (a, v) {
                    "id" !== v && E.push(v, a)
                }), H(u, function (a) {
                    E.push(a)
            ...
            addClass: function (a, g) {
                ...
                -1 === v.indexOf(a) && (g || (a = (v + (v ? " " : "") + a).replace("  ", " ")), this.attr("class", a));
                return this
            },
            hasClass: function (a) {
            ...
            css: function (a) {
                var v = this.styles, r = {}, c = this.element, k, q = "", p, d = !v,
            ...
            updateTransform: function () {
                var a =
                        this.translateX || 0, g = this.translateY || 0, b = this.scaleX, r = this.scaleY, c = this.inverted,
                    k = this.rotation, q = this.element;
            ...
            getBBox: function (a, g) {
                var v, r = this.renderer, c, k = this.element, q = this.styles, p, d = this.textStr, u, m = r.cache,
                    Q = r.cacheKeys, y;
                g = K(g, this.rotation);
                c = g * e;
                p = q && q.fontSize;
            ...
            zIndexSetter: function (a, b) {
                var v = this.renderer,
                    r = this.parentGroup, c = (r || v).element || v.box, k, q = this.element, p;
                k = this.added;
                var d;
        ...
        A.prototype = {
            Element: D, SVG_NS: N, init: function (a, g, b, r, c, q) {
                var v;
                ...
                k && a.getBoundingClientRect && (g = function () {
                    ...
                    l(a, {left: Math.ceil(p.left) - p.left + "px", top: Math.ceil(p.top) - p.top + "px"})
                ...
                g.init(this, a);
                return g
            }, draw: y, getRadialAttr: function (a, g) {
                return {
                ...
                var b =
                        a.element, r = this, v = r.forExport, k = K(a.textStr, "").toString(), q = -1 !== k.indexOf("\x3c"),
                    p = b.childNodes, d, e, u, y, x = n(b, "x"), E = a.styles, z = a.textWidth, f = E && E.lineHeight,
                    H = E && E.textOutline, B = E && "ellipsis" === E.textOverflow, h = E && "nowrap" === E.whiteSpace,
                    t = E && E.fontSize, R, w, M = p.length, E = z && !a.added && this.box, I = function (a) {
                        var v;
                ...
                var v = this.label(a, g, r, u, null, null, null, null, "button"), m = 0;
                v.attr(q({
                    padding: 8,
                    r: 2
                }, k));
                ...
                p(a) ? (r = a, g = r.y, b = r.r, a = r.x) : r = {innerR: r, start: c, end: k};
                ...
                var v = this, q, d = /^url\((.*?)\)$/, e = d.test(a), E = !e && (this.symbols[a] ? a : "circle"),
                    u = E && this.symbols[E],
                    y = t(g) && u && u.call(this.symbols, Math.round(g), Math.round(r), c, k, p), x, z;
                u ? (q = this.path(y), q.attr("fill", "none"),
                    b(q, {
                        ...
                        q[a + "Setter"] = function (a, g) {
                            var b = {}, r = this["img" + g], c = "width" === g ? "translateX" : "translateY";
                            this[g] = a;
                ...
                circle: function (a, g, b, r) {
                    ...
                    var k = c.start, q = c.r || b, p = c.r || r || b, v = c.end - .001;
                    b = c.innerR;
                    r = c.open;
                    var d = Math.cos(k), e = Math.sin(k), E = Math.cos(v), v = Math.sin(v);
                    ...
                    var k = Math.min(c && c.r || 0, b, r), q = k + 6, p = c && c.anchorX;
                    c = c && c.anchorY;
                    var v;
                ...
                var k = a.uniqueKey(), q = this.createElement("clipPath").attr({id: k}).add(this.defs);
                ...
                return {x: -a / 3 * Math.sin(g * e), y: r}
            }, label: function (g, c, k, p, d, e, E, u, m) {
                var v = this, y = v.g("button" !== m && "label"), x = y.text = v.text("", 0, 0, E).attr({zIndex: 1}), z,
                    J, f = 0, H = 3, l = 0, B, h, n, R, w, M = {}, I, N, K = /^url\((.*?)\)$/.test(p), Q = K, U, T, O,
                    P;
                ...
                return b(y, {
                    css: function (a) {
                        ...
                        return {width: J.width + 2 * H, height: J.height + 2 * H, x: J.x - H, y: J.y - H}
                    }, shadow: function (a) {
                        a && (T(), z && z.shadow(a));
                        return y
                    }, destroy: function () {
    ...
    (function (a) {
        var D = a.attr, A = a.createElement, G = a.css, F = a.defined, n = a.each, f = a.extend, h = a.isFirefox,
            l = a.isMS, w = a.isWebKit, t = a.pInt, e = a.SVGRenderer, d = a.win, m = a.wrap;
        f(a.SVGElement.prototype, {
            htmlCss: function (a) {
                ...
                if (this.added) {
                    var a = this.renderer, b = this.element, d = this.translateX || 0, c = this.translateY || 0,
                        e = this.x || 0, m = this.y || 0, f = this.textAlign || "left",
                        k = {left: 0, center: .5, right: 1}[f], E = this.styles;
                    G(b, {marginLeft: d, marginTop: c});
                    this.shadows && n(this.shadows, function (a) {
                        G(a, {
                            marginLeft: d + 1, marginTop: c +
                            1
                        })
                    });
                    ...
                    if ("SPAN" === b.tagName) {
                        var p = this.rotation, z = t(this.textWidth), l = E && E.whiteSpace,
                        ...
                        G(b, {
                            left: e +
                            (this.xCorr || 0) + "px", top: m + (this.yCorr || 0) + "px"
                        });
                        w && (E = b.offsetHeight);
                        this.cTT = q
                    }
        ...
        f(e.prototype, {
            html: function (a, b, d) {
                var c = this.createElement("span"), e = c.element,
                    x = c.renderer, l = x.isSVG, k = function (a, b) {
    ...
    (function (a) {
        var D, A, G = a.createElement, F = a.css, n = a.defined, f = a.deg2rad, h = a.discardElement, l = a.doc,
            w = a.each, t = a.erase, e = a.extend;
        D = a.extendClass;
        var d = a.isArray, m = a.isNumber, C = a.isObject, b = a.merge;
        A = a.noop;
        var x = a.pick, c = a.pInt,
            u = a.SVGElement, B = a.SVGRenderer, I = a.win;
        a.svg || (A = {
            docMode8: l && 8 === l.documentMode, init: function (a, b) {
                var c = ["\x3c", b, ' filled\x3d"f" stroked\x3d"f"'], k = ["position: ", "absolute", ";"],
                    d = "div" === b;
                ...
                return this
            }, updateTransform: u.prototype.htmlUpdateTransform, setSpanRotation: function () {
                ...
                var k = d ? Math.cos(d * f) : 1, p = d ? Math.sin(d * f) : 0,
                    m = x(this.elemHeight, this.element.offsetHeight), u;
                this.xCorr = 0 > k && -a;
                this.yCorr = 0 > p && -m;
                u = 0 > k * p;
                ...
                return b.css(a)
            }, css: u.prototype.htmlCss, safeRemoveChild: function (a) {
                a.parentNode && h(a)
            }, destroy: function () {
            ...
            on: function (a, b) {
                ...
                if (a) {
                    ...
                    for (p = 1; 3 >= p; p++)f = 2 * E + 1 - 2 * p, d && (J = this.cutOffPath(r.value, f + .5)), g = ['\x3cshape isShadow\x3d"true" strokeweight\x3d"',
                        f, '" filled\x3d"false" path\x3d"', J, '" coordsize\x3d"10 10" style\x3d"', q.style.cssText, '" /\x3e'], m = G(e.prepVML(g), null, {
            ...
            Element: A, isIE8: -1 < I.navigator.userAgent.indexOf("MSIE 8.0"), init: function (a, b, c) {
                var k, d;
                this.alignedObjects = [];
                ...
                var k = this.createElement(), q = C(a);
                return e(k, {
                    members: [],
                    count: 0,
                    left: (q ? a.x : a) + 1,
                    ...
                    getCSS: function (a) {
                        var b = a.element, c = b.nodeName, g = a.inverted,
                            r = this.top - ("shape" === c ? b.offsetTop : 0), q = this.left, b = q + this.width,
                            k = r + this.height,
                            r = {clip: "rect(" + Math.round(g ? q : r) + "px," + Math.round(g ? k : b) + "px," + Math.round(g ? b : k) + "px," + Math.round(g ? r : q) + "px)"};
                        !g && a.docMode8 && "DIV" === c && e(r, {width: b + "px", height: k + "px"});
                        return r
                    },
                ...
                if (u) {
                    ...
                    if ("fill" === d)if ("gradient" === u) d = J.x1 || J[0] || 0, b = J.y1 || J[1] || 0, f = J.x2 || J[2] || 0, J = J.y2 || J[3] || 0, E = 'angle\x3d"' + (90 - 180 * Math.atan((J - b) / (f - d)) / Math.PI) + '"', t(); else {
                        var g = J.r, n = 2 * g, I = 2 * g, A = J.cx, D = J.cy, F = c.radialReference, L,
                            g = function () {
                ...
                return a
            }, text: B.prototype.html, path: function (a) {
            ...
            image: function (a, b, c, d, e) {
                var q = this.createElement("img").attr({src: a});
                1 < arguments.length && q.attr({x: b, y: c, width: d, height: e});
                return q
            }, createElement: function (a) {
                ...
                arc: function (a, b, c, d, e) {
                    ...
                    c = e.innerR;
                    d = Math.cos(q);
                    var m = Math.sin(q), g = Math.cos(k), r = Math.sin(k);
                    if (0 === k - q)return ["x"];
    ...
    (function (a) {
        function D() {
            var f = a.defaultOptions.global, h = l.moment;
            if (f.timezone) {
        ...
        function A() {
            var f =
                a.defaultOptions.global, t, e = f.useUTC, d = e ? "getUTC" : "get", m = e ? "setUTC" : "set";
        ...
        var G = a.color,
            F = a.each, n = a.getTZOffset, f = a.merge, h = a.pick, l = a.win;
        a.defaultOptions = {
    ...
    (function (a) {
        var D = a.correctFloat, A = a.defined, G = a.destroyObjectProperties, F = a.isNumber, n = a.merge, f = a.pick,
            h = a.deg2rad;
        ...
        a.Tick.prototype = {
            addLabel: function () {
                var a = this.axis, h = a.options, t = a.chart, e = a.categories, d = a.names, m = this.pos,
                    C = h.labels, b = a.tickPositions, x = m === b[0], c = m === b[b.length - 1],
                    d = e ? f(e[m], d[m], m) : m, e = this.label, b = b.info, u;
                ...
                var l = this.axis, t = a.x, e = l.chart.chartWidth, d = l.chart.spacing,
                    m = f(l.labelLeft, Math.min(l.pos, d[3])), d = f(l.labelRight, Math.max(l.pos + l.len, e - d[1])),
                    C = this.label, b = this.rotation, x = {left: 0, center: .5, right: 1}[l.labelAlign],
                    c = C.getBBox().width, u = l.getSlotWidth(), B = u, n = 1, k, E = {};
                if (b) 0 > b && t - x * c < m ? k = Math.round(t / Math.cos(b * h) - m) : 0 < b && t + x * c > d && (k = Math.round((e - t) / Math.cos(b * h))); else if (e = t + (1 - x) * c, t - x * c < m ? B = a.x + B * (1 - x) - m : e > d && (B = d - a.x + B * x, n = -1), B = Math.min(u, B), B < u && "center" === l.labelAlign && (a.x += n * (u - B - x * (u - Math.min(c, B)))), c > B || l.autoRotation && (C.styles || {}).width) k = B;
                ...
                var x = this.axis, c = x.transA, u = x.reversed, l = x.staggerLines, t = x.tickRotCorr || {x: 0, y: 0},
                    k = d.y;
                ...
                var e = this.axis, d = e.options, m = this.gridLine, l = {}, b = this.pos, x = this.type,
                    c = e.tickmarkOffset, u = e.chart.renderer, B = x ? x + "Grid" : "grid", n = d[B + "LineWidth"],
                    k = d[B + "LineColor"], d = d[B + "LineDashStyle"];
                ...
                var e = this.axis, d = e.options, m = e.chart.renderer, l = this.type, b = l ? l + "Tick" : "tick",
                    x = e.tickSize(b), c = this.mark, u = !c, B = a.x;
                a = a.y;
                var t = f(d[b + "Width"], !l && e.isXAxis ? 1 : 0), d = d[b + "Color"];
                ...
                var d = this.axis, m = d.horiz, l = d.options, b = this.label, x = l.labels, c = x.step,
                    u = d.tickmarkOffset, B = !0, t = a.x;
                a = a.y;
                ...
                var e = this.axis, d = e.horiz, m = this.getPosition(d, this.pos, e.tickmarkOffset, h), l = m.x,
                    b = m.y, e = d && l === e.pos + e.len || !d && b === e.pos ? -1 : 1;
                n = f(n, 1);
                this.isActive = !0;
    ...
    var S = function (a) {
        var D =
            ...
            h = a.defaultOptions, l = a.defined, w = a.deg2rad, t = a.destroyObjectProperties, e = a.each, d = a.extend,
            m = a.fireEvent, C = a.format, b = a.getMagnitude, x = a.grep, c = a.inArray, u = a.isArray, B = a.isNumber,
            I = a.isString, k = a.merge, E = a.normalizeTickInterval, p = a.objectEach, z = a.pick, M = a.removeEvent,
            q = a.splat, y = a.syncTimeout, H = a.Tick, K = function () {
                this.init.apply(this, arguments)
            };
        a.extend(K.prototype, {
            ...
            init: function (a, b) {
                ...
                b = r.options.events;
                -1 === c(r, a.axes) && (g ? a.axes.splice(a.xAxis.length, 0, r) : a.axes.push(r), a[r.coll].push(r));
                r.series = r.series || [];
            ...
            defaultLabelFormatter: function () {
                var b = this.axis, c = this.value, d = b.categories, q = this.dateTimeLabelFormat, k = h.lang,
                    e = k.numericSymbols, k = k.numericSymbolMagnitude || 1E3, p = e && e.length, v,
                    m = b.options.labels.format, b = b.isLog ? Math.abs(c) : b.tickInterval;
                if (m) v = C(m, this); else if (d) v = c; else if (q) v =
                    a.dateFormat(q, c); else if (p && 1E3 <= b)for (; p-- && void 0 === v;)d = Math.pow(k, p + 1), b >= d && 0 === 10 * c % d && null !== e[p] && 0 !== c && (v = a.numberFormat(c / d, -1) + e[p]);
                ...
                e(a.series, function (g) {
                    if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                        ...
                        if (a.isXAxis) c = g.xData, c.length && (g = F(c), B(g) || g instanceof Date || (c = x(c, function (a) {
                            return B(a)
                        }), g = F(c)), a.dataMin = Math.min(z(a.dataMin, c[0]), g), a.dataMax = Math.max(z(a.dataMax, c[0]), G(c))); else if (g.getExtremes(), d = g.dataMax, g = g.dataMin, l(g) && l(d) && (a.dataMin = Math.min(z(a.dataMin, g), g), a.dataMax = Math.max(z(a.dataMax, d), d)), l(r) && (a.threshold = r), !c.softThreshold || a.positiveValuesOnly) a.softThreshold = !1
                    }
                })
            },
            translate: function (a, b, c, d, q,
                                 k) {
                var g = this.linkedParent || this, r = 1, e = 0, p = d ? g.oldTransA : g.transA;
                d = d ? g.oldMin : g.min;
            ...
            getPlotLinePath: function (a, b, c, d, q) {
                var g = this.chart, r = this.left, k = this.top, e, p, m = c && g.oldChartHeight || g.chartHeight,
                    u = c && g.oldChartWidth || g.chartWidth, y;
                e = this.transB;
            ...
            getMinorTickPositions: function () {
                var a = this, b = a.options, c = a.tickPositions, d = a.minorTickInterval, q = [],
                    k = a.pointRangePadding || 0, p = a.min - k, k = a.max + k, v = k - p;
                if (v && v / d < a.len / 3)if (a.isLog) e(this.paddedTicks, function (b, g, c) {
                    g && q.push.apply(q, a.getLogTickPositions(d, c[g - 1], c[g], !0))
                }); else if (a.isDatetimeAxis &&
                    "auto" === b.minorTickInterval) q = q.concat(a.getTimeTicks(a.normalizeTimeTickInterval(d), p, k, b.startOfWeek)); else for (b = p + (c[0] - p) % d; b <= k && b !== q[0]; b += d)q.push(b);
                0 !== q.length && a.trimTicks(q);
                return q
            },
            adjustForMinRange: function () {
                var a = this.options, b = this.min, c = this.max, d, q = this.dataMax - this.dataMin >= this.minRange,
                    k, p, v, m, u, y;
                this.isXAxis && void 0 === this.minRange && !this.isLog && (l(a.min) || l(a.max) ? this.minRange = null : (e(this.series, function (a) {
                    m = a.xData;
                    for (p = u = a.xIncrement ? 1 : m.length - 1; 0 < p; p--)if (v = m[p] -
            ...
            setAxisTranslation: function (a) {
                var b = this, g = b.max - b.min, c = b.axisPointRange || 0, d, q = 0, k = 0, p = b.linkedParent,
                    m = !!b.categories, u = b.transA, y = b.isXAxis;
            ...
            setTickInterval: function (g) {
                var c = this, d = c.chart, q = c.options, k = c.isLog, p = c.log2lin, u = c.isDatetimeAxis,
                    v = c.isXAxis, y = c.isLinked, x = q.maxPadding,
                    H = q.minPadding, h = q.tickInterval, n = q.tickPixelInterval, C = c.categories, t = c.threshold,
                    I = c.softThreshold, K, w, M, A;
            ...
            trimTicks: function (a, b, c) {
                var g = a[0], d = a[a.length - 1], q = this.minPointOffset || 0;
                if (!this.isLinked) {
                    if (b && -Infinity !== g) this.min = g; else for (; this.min - q > a[0];)a.shift();
                    if (c) this.max = d; else for (; this.max + q < a[a.length - 1];)a.pop();
            ...
            alignToOthers: function () {
                ...
                !1 === this.chart.options.chart.alignTicks || !1 === c.alignTicks || this.isLog || e(this.chart[this.coll],
                    function (c) {
                        var g = c.options, g = [c.horiz ? g.left : g.top, g.width, g.height, g.pane].join();
            ...
            adjustTickAmount: function () {
                var a = this.tickInterval, b = this.tickPositions, c = this.tickAmount,
                    d = this.finalTickAmt, q = b && b.length;
                if (q < c) {
            ...
            zoom: function (a, b) {
                var c = this.dataMin, g = this.dataMax, d = this.options, q = Math.min(c, z(d.min, c)),
                    d = Math.max(g, z(d.max, g));
                if (a !== this.min || b !== this.max) this.allowZoomOutside || (l(c) && (a < q && (a = q), a > d && (a = d)), l(g) && (b < q && (b = q), b > d && (b = d))), this.displayBtn = void 0 !== a || void 0 !== b, this.setExtremes(a, b, !1, void 0, {trigger: "zoom"});
                return !0
            },
            setAxisSize: function () {
                var a = this.chart,
                    b = this.options, c = b.offsets || [0, 0, 0, 0], d = this.horiz,
                    q = z(b.width, a.plotWidth - c[3] + c[1]), k = z(b.height, a.plotHeight - c[0] + c[2]),
                    p = z(b.top, a.plotTop + c[0]), b = z(b.left, a.plotLeft + c[3]), c = /%$/;
            ...
            tickSize: function (a) {
                ...
                "Length"], g = z(b[a + "Width"], "tick" === a && this.isXAxis ? 1 : 0);
            ...
            unsquish: function () {
                var a = this.options.labels, b = this.horiz, c = this.tickInterval, d = c,
                    q = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / c), k, p = a.rotation,
                    v = this.labelMetrics(), m, u = Number.MAX_VALUE, y, x = function (a) {
                        a /= q || 1;
                        a = 1 <
                        a ? Math.ceil(a) : 1;
                        return a * c
            ...
            getSlotWidth: function () {
                var a = this.chart, b = this.horiz, c = this.options.labels,
                    d = Math.max(this.tickPositions.length - (this.categories ? 0 : 1), 1), q = a.margin[3];
                return b && 2 > (c.step || 0) && !c.rotation &&
                    (this.staggerLines || 1) * this.len / d || !b && (q && q - a.spacing[3] || .33 * a.chartWidth)
            },
            renderUnsquish: function () {
                var a = this.chart, b = a.renderer, c = this.tickPositions, d = this.ticks, q = this.options.labels,
                    p = this.horiz, m = this.getSlotWidth(), v = Math.max(1, Math.round(m - 2 * (q.padding || 5))),
                    u = {}, y = this.labelMetrics(), x = q.style && q.style.textOverflow, f, H = 0, h, l;
                ...
                if (this.autoRotation) H > v && H > y.h ? u.rotation =
                    this.labelRotation : this.labelRotation = 0; else if (m && (f = {width: v + "px"}, !x))for (f.textOverflow = "clip", h = c.length; !p && h--;)if (l = c[h], v = d[l].label) v.styles && "ellipsis" === v.styles.textOverflow ? v.css({textOverflow: "clip"}) : d[l].labelLength > m && v.css({width: m + "px"}), v.getBBox().height > this.len / c.length - (y.h - y.f) && (v.specCss = {textOverflow: "ellipsis"});
            ...
            addTitle: function (a) {
                ...
                this.axisTitle || ((q = d.textAlign) || (q = (c ? {low: "left", middle: "center", high: "right"} : {
                    low: g ? "right" : "left",
                    middle: "center", high: g ? "left" : "right"
            ...
            getOffset: function () {
                var a = this, b = a.chart, c = b.renderer, d = a.options, q = a.tickPositions, k = a.ticks, m = a.horiz,
                    v = a.side, u = b.inverted ? [1, 0, 3, 2][v] : v, y, x, f =
                        0, H, h = 0, B = d.title, n = d.labels, E = 0, C = b.axisOffset, b = b.clipOffset,
                    t = [-1, 1, 1, -1][v], I = d.className, K = a.axisParent, w = this.tickSize("tick");
                y = a.hasData();
            ...
            getLinePath: function (a) {
                var b = this.chart, c = this.opposite,
                    g = this.offset, d = this.horiz, q = this.left + (c ? this.width : 0) + g,
            ...
            getTitlePosition: function () {
                var a =
                        this.horiz, b = this.left, c = this.top, d = this.len, q = this.options.title, k = a ? b : c,
                    p = this.opposite, e = this.offset, m = q.x || 0, u = q.y || 0,
            ...
            render: function () {
                var b = this, c = b.chart, d = b.options, q = b.isLog, k = b.lin2log, m = b.isLinked,
                    u = b.tickPositions, v = b.axisTitle, x = b.ticks, f = b.minorTicks, h = b.alternateBands,
                    l = d.stackLabels, B = d.alternateGridColor, z =
                        b.tickmarkOffset, n = b.axisLine, E = b.showAxis, C = A(c.renderer.globalAnimation), t, I;
            ...
            drawCrosshair: function (a, b) {
                ...
                this.crosshair && !1 !== (l(b) || !g) ? (g ? l(b) && (q = this.isXAxis ? b.plotX : this.len - b.plotY) : q = a && (this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos), l(q) && (c = this.getPlotLinePath(b && (this.isXAxis ? b.x : z(b.stackY, b.y)), null, null, null, q) || null), l(c) ? (b = this.categories && !this.isRadial, k || (this.cross = k = this.chart.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (b ? "category " : "thin ") + d.className).attr({zIndex: z(d.zIndex, 2)}).add(), k.attr({
                    stroke: d.color ||
                    (b ? n("#ccd6eb").setOpacity(.25).get() : "#cccccc"), "stroke-width": z(d.width, 1)
    ...
    (function (a) {
        var D = a.Axis, A = a.Date, G = a.dateFormat, F = a.defaultOptions, n = a.defined, f = a.each, h = a.extend,
            l = a.getMagnitude, w = a.getTZOffset, t = a.normalizeTickInterval, e = a.pick,
            d = a.timeUnits;
        D.prototype.getTimeTicks = function (a, l, b, x) {
            var c = [], m = {}, B = F.global.useUTC, t, k = new A(l - Math.max(w(l), w(b))), E = A.hcMakeTime,
                p = a.unitRange, z = a.count, C;
            if (n(l)) {
                ...
                t = k[A.hcGetFullYear]();
                x = k[A.hcGetMonth]();
                var q = k[A.hcGetDate](), y = k[A.hcGetHours]();
        ...
        D.prototype.normalizeTimeTickInterval = function (a, e) {
            var b = e || [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day",
                    [1, 2]], ["week", [1, 2]], ["month", [1, 2, 3, 4, 6]], ["year", null]];
            e = b[b.length - 1];
            var m = d[e[0]], c = e[1], u;
    ...
    (function (a) {
        var D = a.Axis, A = a.getMagnitude, G = a.map, F = a.normalizeTickInterval, n = a.pick;
    ...
    (function (a, D) {
        var A = a.arrayMax, G = a.arrayMin, F = a.defined, n = a.destroyObjectProperties, f = a.each, h = a.erase,
            l = a.merge, w = a.pick;
        ...
        a.PlotLineOrBand.prototype = {
            render: function () {
                var f =
                        this, e = f.axis, d = e.horiz, m = f.options, h = m.label, b = f.label, x = m.to, c = m.from,
                    u = m.value, B = F(c) && F(x), n = F(u), k = f.svgElem, E = !k, p = [], z = m.color,
                    M = w(m.zIndex, 0), q = m.events,
                    p = {"class": "highcharts-plot-" + (B ? "band " : "line ") + (m.className || "")}, y = {},
                    H = e.chart.renderer, K = B ? "bands" : "lines", g = e.log2lin;
                ...
                if (n) p = e.getPlotLinePath(u, k.strokeWidth()); else if (B) p = e.getPlotBandPath(c, x, m); else return;
                E && p && p.length ? (k.attr({d: p}), q && a.objectEach(q, function (a, b) {
                    k.on(b, function (a) {
                        q[b].apply(f, [a])
                    })
                })) : k && (p ? (k.show(), k.animate({d: p})) : (k.hide(), b && (f.label = b = b.destroy())));
        ...
        a.extend(D.prototype, {
            getPlotBandPath: function (a, e) {
                var d = this.getPlotLinePath(e, null, null, !0), m = this.getPlotLinePath(a, null, null, !0),
                    f = this.horiz, b = 1;
            ...
            addPlotBand: function (a) {
                ...
                var d = (new a.PlotLineOrBand(this, f)).render(), m = this.userOptions;
                ...
                f([d.plotLines || [], m.plotLines || [], d.plotBands ||
                [], m.plotBands || []], function (b) {
    ...
    (function (a) {
        var D = a.dateFormat, A = a.each, G = a.extend, F = a.format, n = a.isNumber, f = a.map, h = a.merge,
            l = a.pick, w = a.splat, t = a.syncTimeout, e = a.timeUnits;
        a.Tooltip = function () {
            this.init.apply(this, arguments)
        };
        a.Tooltip.prototype = {
            init: function (a, e) {
                ...
                var d, b = this.chart,
                    m = b.inverted, c = b.plotTop, u = b.plotLeft, h = 0, l = 0, k, n;
                a = w(a);
                d = a[0].tooltipPos;
                ...
                var b = this.chart,
                    d = this.distance, c = {}, u = f.h || 0, m,
                    h = ["y", b.chartHeight, e, f.plotY + b.plotTop, b.plotTop, b.plotTop + b.plotHeight],
                    ...
                    p = function (a, b, q, g, k, e) {
                        var p = q < g - d, m = g + d + q < b, y = g - d - q;
                        g += d;
                        if (n && m) c[a] = g; else if (!n && p) c[a] = y; else if (p) c[a] = Math.min(e - q, 0 > y - u ? y : y - u); else if (m) c[a] = Math.max(k, g + u + q > b ? g : g + u); else return !1
                    }, z = function (a, b, q, g) {
                        var k;
                ...
                }), f = {x: c[0].category, y: c[0].y}, f.points = h, c = c[0]);
                this.len = h.length;
                f = d.call(f, this);
                k = c.series;
                ...
                !1 === f ? this.hide() : (d = this.getLabel(), this.isHidden && d.attr({opacity: 1}).show(), this.split ? this.renderSplit(f, a) : (d.attr({
                    text: f && f.join ?
                        f.join("") : f
                }), d.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + l(c.colorIndex, k.colorIndex)), d.attr({stroke: b.borderColor || c.color || k.color || "#666666"}), this.updatePosition({
                    plotX: e,
                    plotY: m,
                    negative: c.negative,
                    ttBelow: c.ttBelow,
                ...
                A(d.slice(0, e.length + 1), function (a, d) {
                    ...
                    var p = d.series || f, x = p.tt, q = d.series ||
                ...
                var d = D("%m-%d %H:%M:%S.%L", f), c, u, m = {millisecond: 15, second: 12, minute: 9, hour: 6, day: 3},
                    l = "millisecond";
                for (u in e) {
                ...
                e = a.series;
                var b = e.tooltipOptions, f = b.xDateFormat, c = e.xAxis,
                    u = c && "datetime" === c.options.type && n(a.key), d = b[d + "Format"];
    ...
    (function (a) {
        var D = a.addEvent, A = a.attr, G = a.charts, F = a.color, n = a.css, f = a.defined, h = a.doc, l = a.each,
            w = a.extend, t = a.fireEvent, e = a.offset, d = a.pick, m = a.removeEvent, C = a.splat, b = a.Tooltip,
            x = a.win;
        ...
        a.Pointer.prototype = {
            init: function (a, e) {
                ...
                return w(a, {chartX: Math.round(c), chartY: Math.round(b)})
                ...
                c.sort(function (a, c) {
                    var d = a.distX - c.distX, e = a.dist - c.dist,
                ...
                if (b && c[0] && !c[0].series.noSharedTooltip)for (a =
                ...
                m ? k ? (h = [], l(f, function (a) {
                    var b = a.noSharedTooltip && k, q = !k && a.directTouch;
                ...
                var c = this.chart, f = c.tooltip, k = f ? f.shared : !1, m = e || c.hoverPoint,
                ...
                var c = this.chart, d = c.hoverSeries, e = c.hoverPoint, f = c.hoverPoints, p = c.tooltip,
                    m = p && p.shared ? f : e;
                ...
                var b = this.chart, c = b.options.chart, d = a.chartX, e = a.chartY, f = this.zoomHor,
                    p = this.zoomVert, m = b.plotLeft, x = b.plotTop, q = b.plotWidth, y = b.plotHeight, h,
                    l = this.selectionMarker,
                    g = this.mouseDownX, r = this.mouseDownY, n = c.panKey && a[c.panKey + "Key"];
                ...
                if (this.selectionMarker) {
                    var e = {originalEvent: a, xAxis: [], yAxis: []}, m = this.selectionMarker,
                        p = m.attr ? m.attr("x") : m.x, x = m.attr ? m.attr("y") : m.y,
                        h = m.attr ? m.attr("width") : m.width, q = m.attr ? m.attr("height") : m.height, y;
                    if (this.hasDragged || d) l(c.axes, function (c) {
                        if (c.zoomEnabled && f(c.min) && (d || b[{xAxis: "zoomX", yAxis: "zoomY"}[c.coll]])) {
                            var k =
                                    c.horiz, g = "touchend" === a.type ? c.minPixelPadding : 0,
                                m = c.toValue((k ? p : x) + g), k = c.toValue((k ? p + h : x + q) - g);
    ...
    (function (a) {
        var D = a.charts, A = a.each, G = a.extend, F = a.map, n = a.noop, f = a.pick;
        G(a.Pointer.prototype, {
            pinchTranslate: function (a, f, n, t, e, d) {
                ...
                var b = this.chart, x = a ? "x" : "y", c = a ? "X" : "Y", h = "chart" + c, l = a ? "width" : "height",
                    w = b["plot" + (a ? "Left" : "Top")], k, E, p = C || 1, z = b.inverted, M = b.bounds[a ? "h" : "v"],
                    q = 1 === f.length, y = f[0][h], H = n[0][h], K = !q && f[1][h], g = !q && n[1][h], r;
                n = function () {
                ...
                var h = this, w = h.chart, t = h.pinchDown, e = a.touches, d = e.length, m = h.lastValidTouch,
                    C = h.hasZoom, b = h.selectionMarker, x = {},
    ...
    (function (a) {
        var D = a.addEvent, A = a.charts, G = a.css, F = a.doc, n = a.extend, f = a.noop, h = a.Pointer,
            l = a.removeEvent, w = a.win, t = a.wrap;
        if (!a.hasTouch && (w.PointerEvent || w.MSPointerEvent)) {
            var e =
                {}, d = !!w.PointerEvent, m = function () {
                var b = [];
                b.item = function (a) {
                    return this[a]
                };
    ...
    (function (a) {
        var D, A = a.addEvent, G = a.css, F = a.discardElement, n = a.defined,
            f = a.each, h = a.isFirefox, l = a.marginNames, w = a.merge, t = a.pick, e = a.setAnimation,
            d = a.stableSort, m = a.win, C = a.wrap;
        ...
        D.prototype = {
            init: function (a, d) {
                ...
                var c = this.options, e = b.legendItem, f = b.legendLine, m = b.legendSymbol,
                    k = this.itemHiddenStyle.color, c = d ? c.itemStyle.color : k, h = d ? b.color || k : k,
                    p = b.options &&
                        b.options.marker, x = {fill: h};
                ...
                var b = this.chart, c = b.renderer, d = this.options, e = "horizontal" === d.layout,
                    f = this.symbolWidth, k = d.symbolPadding, m = this.itemStyle, p = this.itemHiddenStyle,
                    h = this.padding, n = e ? t(d.itemDistance, 20) : 0, q = !d.rtl, y = d.width,
                    l = d.itemMarginBottom || 0, K = this.itemMarginTop, g = a.legendItem, r = !a.series,
                    C = !r && a.series.drawLegendSymbol ? a.series : a, J = C.options,
                    J = this.createCheckboxForItem && J && J.showCheckbox, N = d.useHTML, A = a.options.className;
                g || (a.legendGroup =
                    c.g("legend-item").addClass("highcharts-" + C.type + "-series highcharts-color-" + a.colorIndex + (A ? " " + A : "") + (r ? " highcharts-series-" + a.index : "")).attr({zIndex: 1}).add(this.scrollGroup), a.legendItem = g = c.text("", q ? f + k : -k, this.baseline || 0, N).css(w(a.visible ? m : p)).attr({
                    align: q ? "left" : "right",
                    zIndex: 2
                ...
                var a = this, e = a.chart, c = e.renderer, m = a.group, h, n, k, l, p = a.box, z = a.options,
                    t = a.padding;
                a.itemX = t;
                ...
                p.attr({
                    ...
                    "stroke-width": z.borderWidth || 0, fill: z.backgroundColor || "none"
                }).shadow(z.shadow);
                ...
                var b = this, c = this.chart, d = c.renderer, e = this.options, m = e.y, k = this.padding,
                    c = c.spacingBox.height + ("top" === e.verticalAlign ?
                            -m : m) - k, m = e.maxHeight, h, p = this.clipRect, l = e.navigation,
                    n = t(l.animation, !0), q = l.arrowSize || 12, y = this.nav, H = this.pages, K, g = this.allItems,
                    r = function (a) {
                        "number" === typeof a ? p.attr({height: a}) : p && (b.clipRect = p.destroy(), b.contentGroup.clip());
                ...
                a > c && !1 !== l.enabled ? (this.clipHeight = h = Math.max(c - 20 - this.titleHeight -
                    ...
                    c !== K && (K = c)
                }), p || (p = b.clipRect = d.clipRect(0, k, 9999, 0), b.contentGroup.clip(p)), r(h), y || (this.nav = y = d.g().attr({zIndex: 1}).add(this.group), this.up = d.symbol("triangle", 0, 0, q, q).on("click", function () {
                    b.scroll(-1, n)
                    ...
                    b.scroll(1, n)
                }).add(y)), b.scroll(0), a = c) : y && (r(), this.nav = y.destroy(), this.scrollGroup.attr({translateY: 1}), this.clipHeight = 0);
                return a
            }, scroll: function (a, d) {
                var b = this.pages, f = b.length;
                a = this.currentPage + a;
                var m = this.clipHeight, h = this.options.navigation, k = this.pager, l = this.padding;
                a > f && (a = f);
                0 < a && (void 0 !== d && e(d, this.chart), this.nav.attr({
                    translateX: l, translateY: m + this.padding +
                ...
                }), this.up.attr({fill: 1 === a ? h.inactiveColor : h.activeColor}).css({cursor: 1 === a ? "default" : "pointer"}), this.down.attr({fill: a === f ? h.inactiveColor : h.activeColor}).css({cursor: a === f ? "default" : "pointer"}), d = -b[a - 1] + this.initialItemY,
        ...
        a.LegendSymbolMixin = {
            drawRectangle: function (a, d) {
                ...
                var b = this.options, c = b.marker, d = a.symbolWidth, e = a.symbolHeight, f = e / 2,
                    k = this.chart.renderer, m =
                        this.legendGroup;
    ...
    (function (a) {
        var D = a.addEvent, A = a.animate, G = a.animObject, F = a.attr, n = a.doc, f = a.Axis, h = a.createElement,
            l = a.defaultOptions, w = a.discardElement, t = a.charts, e = a.css, d = a.defined, m = a.each,
            C = a.extend, b = a.find, x = a.fireEvent, c = a.getStyle, u = a.grep, B = a.isNumber, I = a.isObject,
            k = a.isString, E = a.Legend, p = a.marginNames, z = a.merge, M = a.objectEach, q = a.Pointer, y = a.pick,
            H = a.pInt, K = a.removeEvent, g = a.seriesTypes,
            r = a.splat, R = a.svg, J = a.syncTimeout, N = a.win, O = a.Renderer, P = a.Chart = function () {
        ...
        C(P.prototype, {
            callbacks: [], getArgs: function () {
                ...
                var c = this.axes, d = this.series, g = this.pointer, e = this.legend, q = this.isDirtyLegend, f, k,
                    p = this.hasCartesianSeries, y = this.isDirtyBox, r, h = this.renderer, v = h.isHidden(), l = [];
                this.setResponsive && this.setResponsive(!1);
                a.setAnimation(b, this);
                v && this.temporaryDisplay();
                this.layOutTitles();
                for (b = d.length; b--;)if (r = d[b], r.options.stacking && (f = !0, r.isDirty)) {
                    k = !0;
                    break
                }
                if (k)for (b = d.length; b--;)r = d[b], r.options.stacking && (r.isDirty = !0);
                m(d, function (a) {
                ...
                var a = this, b = this.options, c = b.xAxis = r(b.xAxis || {}), b = b.yAxis = r(b.yAxis || {});
                m(c, function (a, b) {
                    a.index = b;
                    a.isX = !0
                });
                ...
                m(["title", "subtitle"], function (a) {
                    ...
                    var q;
                    c && (q = e.style.fontSize, q = d.fontMetrics(q, c).b, c.css({width: (e.width || g.width + e.widthAdjust) + "px"}).align(C({y: a + q}, e), !1, "spacingBox"), e.floating || e.verticalAlign || (b = Math.ceil(b + c.getBBox(e.useHTML).height)))
                }, this);
                ...
                var b = this.options.chart, g = b.width, b = b.height, e = this.renderTo;
                ...
                var d = this.renderTo;
                if (b)for (; d && d.style;)d.hcOrigStyle && (a.css(d, d.hcOrigStyle),
                    delete d.hcOrigStyle), d = d.parentNode; else for (; d && d.style;)"none" === c(d, "display", !1) && (d.hcOrigStyle = {
                ...
                var b = this.spacing, c = this.margin, g = this.titleOffset;
                this.resetMargins();
                ...
                var b = this, g = b.options.chart, e = b.renderTo, q = d(g.width), f = g.width || c(e, "width"),
                    g = g.height || c(e, "height"), e = a ? a.target :
                        N;
                ...
                var b = this.inverted,
                    c = this.renderer, d = this.chartWidth, g = this.chartHeight, e = this.options.chart,
                    q = this.spacing, f = this.clipOffset, k, p, y, r;
                ...
                var a = this.options.chart, b = this.renderer, c = this.chartWidth, d = this.chartHeight,
                    g = this.chartBackground, e = this.plotBackground, q = this.plotBorder, f, k = this.plotBGImage,
                    m = a.backgroundColor, p = a.plotBackgroundColor, y = a.plotBackgroundImage, r, h = this.plotLeft,
                    l = this.plotTop, n = this.plotWidth, H = this.plotHeight, x = this.plotBox, u = this.clipRect,
                    z = this.clipBox,
                    t = "animate";
            ...
            renderLabels: function () {
                ...
                b.items && m(b.items, function (c) {
                    var d = C(b.style, c.style), g = H(d.left) + a.plotLeft, e = H(d.top) + a.plotTop + 12;
                    delete d.left;
                    delete d.top;
    ...
    (function (a) {
        var D, A = a.each, G = a.extend, F = a.erase, n = a.fireEvent, f = a.format, h = a.isArray, l = a.isNumber,
            w = a.pick, t = a.removeEvent;
        D = a.Point = function () {
        };
        D.prototype = {
            init: function (a, d, f) {
                ...
                var e = this.series, f = e.options.pointValKey || e.pointValKey;
                ...
                var d = {}, e = this.series, f = e.options.keys, b = f || e.pointArrayMap || ["y"], n = b.length, c = 0,
                    u = 0;
                if (l(a) || null === a) d[b[0]] = a; else if (h(a))for (!f && a.length > n && (e = typeof a[0], "string" === e ? d.name =
                    a[0] : "number" === e && (d.x = a[0]), c++); u < n;)f && void 0 === a[c] || (d[b[u]] = a[c]), c++, u++; else"object" === typeof a && (d = a, a.dataLabels && (e._hasPointLabels = !0), a.marker && (e._hasPointMarkers = !0));
                return d
                ...
                var d = this.series, e = d.tooltipOptions,
                    h = w(e.valueDecimals, ""), b = e.valuePrefix || "", l = e.valueSuffix || "";
    ...
    (function (a) {
        var D = a.addEvent, A = a.animObject, G = a.arrayMax, F = a.arrayMin, n = a.correctFloat, f = a.Date,
            h = a.defaultOptions, l = a.defaultPlotOptions, w = a.defined, t = a.each, e = a.erase, d = a.extend,
            m = a.fireEvent, C = a.grep, b = a.isArray, x = a.isNumber, c = a.isString, u = a.merge, B = a.objectEach,
            I = a.pick, k = a.removeEvent, E = a.splat, p = a.SVGElement, z = a.syncTimeout, M = a.win;
        a.Series = a.seriesType("line", null, {
            ...
            updateParallelArrays: function (a, b) {
                var c = a.series, d = arguments, g = x(b) ? function (d) {
            ...
            getCyclic: function (a, b, c) {
                var d, g = this.chart, e = this.userOptions, q = a + "Index", f = a + "Counter",
            ...
            setData: function (d, e, f, k) {
                var g = this, q = g.points, m = q && q.length || 0, p, h = g.options, y = g.chart, l = null,
                    n = g.xAxis,
                    u = h.turboThreshold, z = this.xData, H = this.yData, w = (p = g.pointArrayMap) && p.length;
                d = d || [];
                p = d.length;
                e = I(e, !0);
                if (!1 !== k && p && m === p && !g.cropped && !g.hasGroupedData && g.visible) t(d, function (a, b) {
                    ...
                    if (u && p > u) {
                        ...
                        if (x(l))for (f = 0; f < p; f++)z[f] = this.autoIncrement(), H[f] = d[f]; else if (b(l))if (w)for (f = 0; f < p; f++)l = d[f], z[f] = l[0], H[f] = l.slice(1,
                            w + 1); else for (f = 0; f < p; f++)l = d[f], z[f] = l[0], H[f] = l[1]; else a.error(12)
                    } else for (f = 0; f < p; f++)void 0 !== d[f] && (l = {series: g}, g.pointClass.prototype.applyOptions.apply(l, [d[f]]), g.updateParallelArrays(l, f));
                    c(H[0]) && a.error(14, !0);
                    g.data = [];
            ...
            processData: function (b) {
                var c =
                    this.xData, d = this.yData, e = c.length, g;
                g = 0;
                var f, q, k = this.xAxis, m, p = this.options;
                m = p.cropThreshold;
                var h = this.getExtremesFromAll || p.getExtremesFromAll, l = this.isCartesian, p = k && k.val2lin,
                    n = k && k.isLog, u, x;
                if (l && !this.isDirty && !k.isDirty && !this.yAxis.isDirty && !b)return !1;
                k && (b = k.getExtremes(), u = b.min, x = b.max);
                if (l && this.sorted && !h && (!m || e > m || this.forceCrop))if (c[e - 1] < u || c[0] > x) c = [], d = []; else if (c[0] < u || c[e - 1] > x) g = this.cropData(this.xData, this.yData, u, x), c = g.xData, d = g.yData, g = g.start, f = !0;
                for (m = c.length ||
            ...
            generatePoints: function () {
                var a = this.options, b = a.data, c = this.data,
                    d, g = this.processedXData, e = this.processedYData, f = this.pointClass, k = g.length,
                    m = this.cropStart || 0, p, h = this.hasGroupedData, a = a.keys, l, n = [], u;
                ...
                this.options.keys = a;
                if (c && (k !== (d = c.length) || h))for (u = 0; u < d; u++)u !== m || h || (u += k), c[u] && (c[u].destroyElements(),
                    c[u].plotX = void 0);
                this.data = c;
                this.points = n
            },
            getExtremes: function (a) {
                ...
                e = a.length;
                for (l = 0; l < e; l++)if (p = d[l], h = a[l], m = (x(h, !0) || b(h)) && (!c.positiveValuesOnly || h.length || 0 < h), p = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (d[l] || p) >= q && (d[l] || p) <= k, m && p)if (m = h.length)for (; m--;)null !== h[m] && (g[f++] = h[m]); else g[f++] = h;
                this.dataMin =
                    F(g);
                this.dataMax = G(g)
            },
            translate: function () {
                ...
                this.generatePoints();
                var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, g = this.yAxis, e = this.points,
                    f = e.length, k = !!this.modifyValue, m = a.pointPlacement, p = "between" === m || x(m),
                    h = a.threshold, l = a.startFromThreshold ? h : 0, u, z, t, E, C = Number.MAX_VALUE;
                "between" === m && (m = .5);
                x(m) && (m *= I(a.pointRange || c.pointRange));
                for (a = 0; a < f; a++) {
                    var B = e[a], M = B.x, A = B.y;
                    z = B.low;
            ...
            drawPoints: function () {
                var a = this.points, b = this.chart, c, d, g, e, f = this.options.marker, k, m, p, h,
                    l = this[this.specialGroup] || this.markerGroup,
                    n = I(f.enabled, this.xAxis.isRadial ? !0 : null, this.closestPointRangePx >= 2 * f.radius);
                if (!1 !== f.enabled || this._hasPointMarkers)for (d = 0; d < a.length; d++)g = a[d], c = g.plotY, e = g.graphic, k = g.marker || {}, m = !!g.marker, p = n && void 0 === k.enabled || k.enabled, h = g.isInside, p && x(c) && null !== g.y ? (c = I(k.symbol, this.symbol), g.hasImage = 0 === c.indexOf("url"), p = this.markerAttribs(g,
            ...
            pointAttribs: function (a, b) {
                var c = this.options.marker, d = a && a.options, g = d && d.marker || {}, e = this.color,
                    f = d && d.color, k = a && a.color, d = I(g.lineWidth, c.lineWidth);
            ...
            destroy: function () {
                var a = this, b = a.chart, c = /AppleWebKit\/533/.test(M.navigator.userAgent), d, g, f = a.data || [],
                    h, l;
                m(a, "destroy");
                k(a);
            ...
            getGraphPath: function (a, b, c) {
                ...
                t(a, function (f, p) {
                    var h = f.plotX, l = f.plotY, n = a[p - 1];
            ...
            applyZones: function () {
                var a = this, b = this.chart, c = b.renderer,
                    d = this.zones, g, e, f = this.clips || [], k, m = this.graph, p = this.area,
                    h = Math.max(b.chartWidth, b.chartHeight), l = this[(this.zoneAxis || "y") + "Axis"], n, u,
                    x = b.inverted, z, E, w, B, C = !1;
            ...
            render: function () {
                var a = this, b = a.chart, c, d = a.options,
                    ...
                    e = a.visible ? "inherit" : "hidden", f = d.zIndex, k = a.hasRendered, m = b.seriesGroup,
                    p = b.inverted;
            ...
            redraw: function () {
                var a = this.chart, b = this.isDirty || this.isDirtyData,
                    c = this.group, d = this.xAxis, g = this.yAxis;
                c && (a.inverted && c.attr({
                    width: a.plotWidth,
                    height: a.plotHeight
                }), c.animate({translateX: I(d && d.left, a.plotLeft), translateY: I(g && g.top, a.plotTop)}));
                this.translate();
                this.render();
            ...
            searchPoint: function (a, b) {
                var c = this.xAxis, d = this.yAxis, g = this.chart.inverted;
    ...
    (function (a) {
        ...
        var A = a.Axis, G = a.Chart,
            F = a.correctFloat, n = a.defined, f = a.destroyObjectProperties, h = a.each, l = a.format,
        ...
        D.prototype = {
            destroy: function () {
                ...
                var d = this.options, e = d.format, e = e ? l(e, this) : d.formatter.call(this);
                ...
                var e = this.axis, f =
                        e.chart, b = f.inverted, h = e.reversed, h = this.isNegative && !h || !this.isNegative && h,
                    c = e.translate(e.usePercentage ? 100 : this.total, 0, 0, 0, 1), e = e.translate(0),
                    e = Math.abs(c - e);
                a = f.xAxis[0].translate(this.x) + a;
                var l = f.plotHeight, b = {
                    x: b ? h ? c : c - e : a,
        ...
        A.prototype.buildStacks = function () {
            ...
            if (!this.isXAxis) {
                ...
                if (this.usePercentage)for (b = 0; b < h; b++)a[b].setPercentStacks()
            }
        };
        A.prototype.renderStackTotals =
            function () {
                var a = this.chart, d = a.renderer, f = this.stacks, h = this.stackTotalGroup;
        ...
        a.prototype.setStackedPoints = function () {
            if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                var a = this.processedXData, d = this.processedYData, f = [], h = d.length, b = this.options,
                    l = b.threshold, c = b.startFromThreshold ? l : 0, u = b.stack, b = b.stacking, w = this.stackKey,
                    A = "-" + w, k = this.negStacks, E = this.yAxis, p = E.stacks, z = E.oldStacks, M, q, y, H, K, g, r;
                E.stacksTouched += 1;
        ...
        a.prototype.setPercentStacks = function () {
            ...
            h([d, "-" + d], function (d) {
                for (var c = l.length, e, h; c--;)if (e = l[c], b = a.getStackIndicator(b, e, a.index, d), e = (h = f[d] && f[d][e]) && h.points[b.key]) h = h.total ? 100 / h.total : 0, e[0] = F(e[0] * h), e[1] = F(e[1] * h),
                    a.stackedYData[c] = e[1]
            })
        };
        a.prototype.getStackIndicator = function (a, d, f, h) {
            !n(a) || a.x !== d || h && a.key !== h ? a = {x: d, index: 0, key: h} : a.index++;
            a.key = [f, d, a.index].join();
            return a
        }
    })(L);
    (function (a) {
        var D = a.addEvent, A = a.animate, G = a.Axis, F = a.createElement, n = a.css, f = a.defined, h = a.each,
            l = a.erase, w = a.extend, t = a.fireEvent, e = a.inArray, d = a.isNumber, m = a.isObject, C = a.isArray,
            b = a.merge, x = a.objectEach, c = a.pick, u = a.Point, B = a.Series, I = a.seriesTypes, k = a.setAnimation,
            E = a.splat;
        w(a.Chart.prototype, {
            addSeries: function (a, b,
                                 d) {
                var e, f = this;
                a && (b = c(b, !0), t(f, "addSeries", {options: a}, function () {
                    e = f.initSeries(a);
                    f.isDirtyLegend = !0;
                    f.linkSeries();
                    b && f.redraw(d)
            ...
            addAxis: function (a, d, e, f) {
                var k = d ? "xAxis" : "yAxis", p = this.options;
            ...
            update: function (a, k) {
                var p = this, m = {credits: "addCredits", title: "setTitle", subtitle: "setSubtitle"}, l = a.chart, n,
                    u;
                if (l) {
        ...
        w(B.prototype, {
            addPoint: function (a, b, d, e) {
                var f = this.options, k = this.data, p = this.chart, g = this.xAxis, g = g && g.hasNames && g.names,
                    h = f.data, m, q, l = this.xData, n, u;
                b = c(b, !0);
                m = {series: this};
                this.pointClass.prototype.applyOptions.apply(m,
                    [a]);
                u = m.x;
                n = l.length;
                if (this.requireSorting && u < l[n - 1])for (q = !0; n && l[n - 1] > u;)n--;
                ...
                var f = this, k = f.chart;
                !1 !== d ? t(f, "remove", null, e) : e()
            }, update: function (a, d) {
                var e = this, f = e.chart, k = e.userOptions, p =
                        e.oldType || e.type, m = a.type || k.type || f.options.chart.type, g = I[p].prototype,
                    l = ["group", "markerGroup", "dataLabelsGroup"], n;
    ...
    (function (a) {
        var D = a.color, A = a.each, G = a.map, F = a.pick, n = a.Series, f = a.seriesType;
        f("area", "line", {softThreshold: !1, threshold: 0}, {
            singleStacks: !1, getStackPoints: function () {
                var f = [], l = [], n = this.xAxis, t = this.yAxis, e = t.stacks[this.stackKey], d = {},
                    m = this.points, C = this.index, b = t.series, x = b.length, c,
                    u = F(t.options.reversedStacks, !0) ? 1 : -1, B;
                if (this.options.stacking) {
                    ...
                    A(l, function (a, b) {
                        ...
                        if (d[a] && !d[a].isNull) f.push(d[a]), A([-1, 1], function (f) {
                            var k = 1 === f ? "rightNull" : "leftNull", p = 0, n = e[l[b + f]];
                            if (n)for (B = C; 0 <= B && B < x;)h = n.points[B], h || (B === C ? d[a][k] = !0 : c[B] && (m = e[a].points[B]) && (p -= m[1] - m[0])), B += u;
                ...
                var f =
                        n.prototype.getGraphPath, h = this.options, t = h.stacking, e = this.yAxis, d, m, C = [], b = [],
                    x = this.index, c, u = e.stacks[this.stackKey], B = h.threshold, A = e.getThreshold(h.threshold), k,
                    h = h.connectNulls || "percent" === t, E = function (d, f, k) {
                        var h = a[d];
                        d = t && u[h.x].points[x];
                        var p = h[k + "Null"] || 0;
                        k = h[k + "Cliff"] || 0;
                        ...
                        void 0 !== m && (b.push({
                            ...
                            plotX: c, plotY: null === l ? A : e.getThreshold(l),
                            doCurve: !1
                        }))
                    };
                a = a || this.points;
                t && (a = this.getStackPoints());
                for (d = 0; d < a.length; d++)if (m = a[d].isNull, c = F(a[d].rectPlotX, a[d].plotX), k = F(a[d].yBottom, A), !m || h) h || E(d, d - 1, "left"), m && !t && h || (b.push(a[d]), C.push({
                    x: d,
                    plotX: c,
                    plotY: k
                })), h || E(d, d + 1, "right");
                ...
                var a = this, f = this.areaPath,
                    w = this.options, t = [["area", "highcharts-area", this.color, w.fillColor]];
                ...
                A(t, function (e) {
                    var d = e[0], h = a[d];
                    h ? (h.endX = f.xMap, h.animate({d: f})) : (h = a[d] = a.chart.renderer.path(f).addClass(e[1]).attr({
    ...
    (function (a) {
        ...
        a("spline", "line", {}, {
            getPointSpline: function (a, G, F) {
                var n = G.plotX, f = G.plotY, h = a[F - 1];
                F = a[F + 1];
                var l, w, t, e;
    ...
    (function (a) {
        var D = a.seriesTypes.area.prototype, A = a.seriesType;
    ...
    (function (a) {
        var D = a.animObject, A = a.color,
            G = a.each, F = a.extend, n = a.isNumber, f = a.merge, h = a.pick, l = a.Series, w = a.seriesType,
            t = a.svg;
        w("column", "line", {
            borderRadius: 0,
            crisp: !0,
            ...
            directTouch: !0, trackerGroups: ["group", "dataLabelsGroup"], negStacks: !0, init: function () {
                ...
                var t = Math.min(Math.abs(f.transA) * (f.ordinalSlope || d.pointRange || f.closestPointRange || f.tickInterval || 1), f.len),
                    w = t * d.groupPadding, k = (t - 2 * w) / (u || 1),
                ...
                var b = this.chart, e = this.borderWidth, c = -(e % 2 ? .5 : 0), e = e % 2 ? .5 : 1;
                ...
                var a = this, d = a.chart, f = a.options, n = a.dense = 2 > a.closestPointRange * a.xAxis.transA,
                    n = a.borderWidth = h(f.borderWidth, n ? 0 : 1), b = a.yAxis,
                    x = a.translatedThreshold = b.getThreshold(f.threshold), c = h(f.minPointLength, 5),
                    u = a.getColumnMetrics(), t = u.width, w = a.barW = Math.max(t, 1 + 2 * n),
                    k = a.pointXOffset = u.offset;
                d.inverted && (x -= .5);
                f.pointPadding && (w = Math.ceil(w));
                l.prototype.translate.apply(a);
                G(a.points, function (e) {
                    var f = h(e.yBottom, x), m = 999 + Math.abs(f), m = Math.min(Math.max(-m, e.plotY), b.len + m),
                        l = e.plotX + k, q = w, n = Math.min(m, f), u, E = Math.max(m, f) - n;
                ...
                var l = b["stroke-width"] || "borderWidth", c = a && a.color || this.color,
                    n = a[h] || e[h] || this.color || c, t = a[l] || e[l] || this[l] || 0, b = e.dashStyle;
                ...
                var d = this, e = this.yAxis, f = d.options, b = this.chart.inverted, h = {};
    ...
    (function (a) {
        var D = a.pick, A = a.relativeLength;
        a.CenteredSeriesMixin = {
            getCenter: function () {
                var a = this.options, F = this.chart, n = 2 * (a.slicedOffset || 0), f = F.plotWidth - 2 * n,
                    F = F.plotHeight - 2 * n, h = a.center,
                    h = [D(h[0], "50%"), D(h[1], "50%"), a.size || "100%", a.innerSize || 0], l = Math.min(f, F), w, t;
    ...
    (function (a) {
        var D = a.addEvent, A = a.defined, G = a.each, F = a.extend, n = a.inArray, f = a.noop, h = a.pick, l = a.Point,
            w = a.Series, t = a.seriesType, e = a.setAnimation;
        t("pie", "line", {
            center: [null, null],
            clip: !1,
            colorByPoint: !0,
            ...
            animate: function (a) {
                var d = this, e = d.points, b = d.startAngleRad;
                a || (G(e, function (a) {
            ...
            translate: function (a) {
                this.generatePoints();
                var d = 0, e = this.options, b = e.slicedOffset, f = b + (e.borderWidth || 0), c, l, n,
                    t = e.startAngle || 0, k = this.startAngleRad = Math.PI / 180 * (t - 90),
                    t = (this.endAngleRad = Math.PI / 180 * (h(e.endAngle, t + 360) - 90)) - k, w = this.points, p,
                    z = e.dataLabels.distance, e = e.ignoreHiddenPoint, A, q = w.length, y;
            ...
            init: function () {
                ...
                var d = this, b = d.series, f = b.chart, c = b.options.ignoreHiddenPoint;
                e = h(e, c);
    ...
    (function (a) {
        var D = a.addEvent, A = a.arrayMax, G = a.defined, F = a.each, n = a.extend, f = a.format, h = a.map,
            l = a.merge, w = a.noop, t = a.pick, e = a.relativeLength, d = a.Series, m = a.seriesTypes,
            C = a.stableSort;
        ...
        d.prototype.drawDataLabels = function () {
            var b = this, d = b.options, c = d.dataLabels, e = b.points, h, n, k = b.hasRendered || 0, m, p,
                z = t(c.defer, !0), w = b.chart.renderer;
            if (c.enabled || b._hasPointLabels) b.dlProcessOptions && b.dlProcessOptions(c), p = b.plotGroup("dataLabelsGroup", "data-labels",
                z && !k ? "hidden" : "visible", c.zIndex || 6), z && (p.attr({opacity: +k}), k || D(b, "afterAnimate", function () {
                b.visible && p.show(!0);
                p[d.animation ? "animate" : "attr"]({opacity: 1}, {duration: 200})
            })), n = c, F(e, function (e) {
        ...
        d.prototype.alignDataLabel = function (a, d, c, e, f) {
            var b = this.chart, k = b.inverted, h = t(a.plotX, -9999), p = t(a.plotY, -9999), l = d.getBBox(), m,
                q = c.rotation, u = c.align,
            ...
            if (x && (m = c.style.fontSize, m = b.renderer.fontMetrics(m, d).b, e = n({
                ...
                }, d[f ? "attr" : "animate"](h).attr({align: u}), p = (q + 720) % 360, p = 180 < p && 360 > p, "left" === u ? h.y -= p ? l.height : 0 : "center" === u ? (h.x -= l.width / 2, h.y -= l.height / 2) : "right" === u && (h.x -= l.width, h.y -= p ?
        ...
        m.pie && (m.pie.prototype.drawDataLabels = function () {
            var b = this, e = b.data, c, f = b.chart, h = b.options.dataLabels, l = t(h.connectorPadding, 10),
                k = t(h.connectorWidth, 1), n = f.plotWidth, p = f.plotHeight, m, w = b.center, q = w[2] /
                    2, y = w[1], C, D, g, r, L = [[], []], J, N, O, P, v = [0, 0, 0, 0];
            b.visible && (h.enabled || b._hasPointLabels) && (F(e, function (a) {
                ...
                if (t)for (b.sortByAngle(d, e - .5), 0 < b.maxLabelDistance && (k = Math.max(0, y - q - b.maxLabelDistance),
    ...
    (function (a) {
        var D = a.Chart, A = a.each, G = a.pick, F = a.addEvent;
        ...
        D.prototype.hideOverlappingLabels = function (a) {
            ...
            for (l = 0; l < f; l++)if (h = a[l]) h.oldOpacity = h.opacity, h.newOpacity = 1;
            a.sort(function (a, b) {
    ...
    (function (a) {
        var D = a.addEvent, A = a.Chart, G = a.createElement, F = a.css, n = a.defaultOptions, f = a.defaultPlotOptions,
            h = a.each, l = a.extend, w = a.fireEvent, t = a.hasTouch, e = a.inArray, d = a.isObject, m = a.Legend,
            C = a.merge, b = a.pick, x = a.Point, c = a.Series, u = a.seriesTypes, B = a.svg, I;
        I = a.TrackerMixin = {
            drawTrackerPoint: function () {
                ...
                var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath : a.graphPath),
                    e = d.length, f = a.chart, l = f.pointer, m =
                        f.renderer, n = f.options.tooltip.snap, g = a.tracker, r, u = function () {
                        if (f.hoverSeries !== a) a.onMouseOver()
                    }, w = "rgba(192,192,192," + (B ? .0001 : .002) + ")";
                if (e && !c)for (r = e + 1; r--;)"M" === d[r] && d.splice(r + 1, 0, d[r + 1] - n, d[r + 2], "L"), (r && "M" === d[r] || r === e) && d.splice(r, 0, "L", d[r - 2] + n, d[r - 1]);
                g ? g.attr({d: d}) : a.graph && (a.tracker = m.path(d).attr({
                        "stroke-linejoin": "round",
        ...
        l(x.prototype, {
            select: function (a, c) {
                var d = this, f = d.series, k = f.chart;
                a = b(a, !d.selected);
                ...
                if (!this.hasImportedEvents) {
                    var b = this, c = C(b.series.options.point, b.options).events;
                    b.events = c;
                ...
                var d = Math.floor(this.plotX), e = this.plotY, h = this.series, k = h.options.states[a] || {},
                    m = f[h.type].marker && h.options.marker, n = m && !1 === m.enabled,
                    t = m && m.states && m.states[a] || {}, g = !1 === t.enabled, r = h.stateMarkerGraphic,
                    u = this.marker || {}, w = h.chart, x = h.halo, A, E = m && h.markerAttribs;
                a = a || "";
                if (!(a === this.state && !c || this.selected && "select" !== a || !1 === k.enabled || a && (g || n && !1 === t.enabled) || a && u.states && u.states[a] && !1 === u.states[a].enabled)) {
                    E && (A = h.markerAttribs(this,
                        a));
                    if (this.graphic) this.state && this.graphic.removeClass("highcharts-point-" + this.state), a && this.graphic.addClass("highcharts-point-" + a), this.graphic.attr(h.pointAttribs(this, a)), A && this.graphic.animate(A, b(w.options.chart.animation, t.animation, m.animation)), r && r.hide(); else {
                        if (a && t) {
                            m = u.symbol || h.symbol;
                    ...
                    (d = k.halo) && d.size ? (x || (h.halo = x = w.renderer.path().add(E ? h.markerGroup : h.group)), x[c ? "animate" : "attr"]({d: this.haloPath(d.size)}), x.attr({"class": "highcharts-halo highcharts-color-" + b(this.colorIndex, h.colorIndex)}), x.point = this, x.attr(l({
        ...
        l(c.prototype, {
            onMouseOver: function () {
                ...
                var c = this, d = c.options, e = c.graph, f = d.states, k = d.lineWidth, d = 0;
                a = a || "";
                if (c.state !== a && (h([c.group, c.markerGroup, c.dataLabelsGroup], function (b) {
                    ...
                    }), c.state = a, !f[a] || !1 !== f[a].enabled) && (a && (k = f[a].lineWidth || k + (f[a].lineWidthPlus || 0)), e && !e.dashstyle))for (k = {"stroke-width": k}, e.animate(k, b(c.chart.options.chart.animation, f[a] &&
    ...
    (function (a) {
        var D = a.Chart, A = a.each, G = a.inArray, F = a.isArray, n = a.isObject, f = a.pick, h = a.splat;
        D.prototype.setResponsive =
            function (f) {
                var h = this.options.responsive, l = [], e = this.currentResponsive;
        ...
        D.prototype.currentOptions = function (f) {
            function l(e, d, f, t) {
                ...
                a.objectEach(e, function (a, c) {
                    if (!t && -1 < G(c, ["series", "xAxis", "yAxis"]))for (e[c] = h(e[c]), f[c] = [], b = 0; b < e[c].length; b++)d[c][b] && (f[c][b] = {}, l(a[b],
                        d[c][b], f[c][b], t + 1)); else n(a) ? (f[c] = F(a) ? [] : {}, l(a, d[c] || {}, f[c], t + 1)) : f[c] = d[c] || null
                })
            }
