            ...
            <div class="demo" style="text-align: left">
                <div class="use">
                    <div class="usename am-list-item-hd">
                        <p class="fx_content2 list_p3"><c:choose>
                        ...
                        <span class="list_span4"><fmt:formatDate value="${obj.createtime}"
                                                                 pattern="yyyy-MM-dd"></fmt:formatDate></span>
                        <span class="list_span3"><fmt:formatDate value="${obj.createtime}"
                                                                 pattern="HH:mm:ss"></fmt:formatDate></span>
                    </div>
                </div>
            </div>
        </div>
