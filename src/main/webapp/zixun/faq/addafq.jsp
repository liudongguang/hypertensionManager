...
<div >
    <form class="form-horizontal" action="webHandler/save_faq" novalidate id="subForm" method="post">
        <div class="form-group">
            ...
            <div class="col-md-8">
                <input type="text" name="title" class="form-control" required errInfo="标题名不能为空"></div>
        </div>
        <input type="hidden" name="pici" value="${param.pici}" id="piciID">
        <textarea required errInfo="内容不能为空" name="content" class="summernote" id="contents" title="Contents"></textarea>
